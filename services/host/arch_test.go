...
var pkgLayer = map[string]int{
	...
	// slack (the OAuth/credential/MCP-registration workflow) was externalized
	// in W2/U02a — see docs/design/slack-setup.md — and this package no longer
	// exists in the public tree.
	//
