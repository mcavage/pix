...
// trustedGogSpawn reports whether a registered gog-shaped command is BOTH the
...
// NORMALIZED argv (canonical executable tokens), the only spawn ever executed
// as a probe.
