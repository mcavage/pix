...
func TestRunState_RoutesToAliasesViaHelp(t *testing.T) {
	cases := map[string]string{
		"backup":    "usage: pi-stack backup",
		"restore":   "usage: pi-stack restore",
		"reset":     "usage: pi-stack reset",
		"uninstall": "usage: pi-stack uninstall",
	}
