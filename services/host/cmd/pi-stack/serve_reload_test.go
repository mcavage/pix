...
func TestPropagateServeConfig_Managed(t *testing.T) {
	...
	if !strings.Contains(out.String(), "restarted managed pi-stack services") {
...
func TestPropagateServeConfig_LazyStopsThenEnsures(t *testing.T) {
	...
	if !strings.Contains(out.String(), "restarted pi-stack services (background)") {
...
func TestPropagateServeConfig_LazyEnsureFails(t *testing.T) {
	...
	if !strings.Contains(out.String(), "warning: pi-stack services were stopped but did not restart") {
...
func TestPropagateServeConfig_LazyStopErrorDoesNotEnsure(t *testing.T) {
	...
	if !strings.Contains(out.String(), "warning: could not stop the background pi-stack services") {
...
func TestPropagateServeConfig_ForegroundTouchesNothing(t *testing.T) {
	...
	if !strings.Contains(out.String(), "foreground `pi-stack serve` is running") {
...
func TestPropagateServeConfig_DownTouchesNothing(t *testing.T) {
	...
	if !strings.Contains(out.String(), "applies next time pi-stack services start") {
