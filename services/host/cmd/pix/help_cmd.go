...
// Run: a TYPED verb has no usage constant to print — `pix help ls` re-enters
// the root as `pix ls --help`, so the usage a user reads is generated from the
