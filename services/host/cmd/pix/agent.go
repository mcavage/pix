...
// model and WHY. You manage AGENTS (their .md files, found by
// resolveAgentsDir — $PIX_AGENTS_DIR, beside the binary, or a repo checkout
// found by climbing from cwd, never a hard cwd requirement); the router
// manages MODELS: an agent stores an INTENT, not a pinned model, and
