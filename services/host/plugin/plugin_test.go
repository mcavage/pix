...
func (noopMemory) Stats(StatsReq) (Stats, error)                            { return Stats{}, nil }
...
func (echoMemory) Stats(StatsReq) (Stats, error)   { return Stats{Active: 11, Durable: 22}, nil }
...
func TestRPCRoundTripMemory(t *testing.T) {
	...
	if got, err := c.Stats(StatsReq{}); err != nil || got.Active != 11 || got.Durable != 22 {
...
func (errMemory) Stats(StatsReq) (Stats, error) { return Stats{}, errors.New("boom: stats failed") }

func TestRPCRoundTripError(t *testing.T) {
	client := newRPCPair(t, &memoryRPCServer{Impl: errMemory{}})
	c := &memoryRPCClient{client: client}

	_, err := c.Stats(StatsReq{})
	if err == nil {
